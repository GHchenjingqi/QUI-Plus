...
const _0x3c6e=['getElementById','reload','theme_code','domain','text','&code_time=theme_time&code_timeval=','激活码异常，请输入正确激活码！','getTime','#err_tip','hide','#success_boom','do=code&code_name=','ajax','show','toString','value','length'];const _0x543e=function(_0x3c6e90,_0x543e7e){_0x3c6e90=_0x3c6e90-0x0;let _0x2eca9d=_0x3c6e[_0x3c6e90];return _0x2eca9d;};let flags=![];function active_theme(){if(flags)return![];flags=!![];let _0x21be78=_0x543e('0x2');let _0x2c847b=document[_0x543e('0x0')]('theme_code')[_0x543e('0xf')];let _0x5e3f7d=document[_0x543e('0x3')];if(!_0x2c847b||_0x2c847b[_0x543e('0x10')]!=0x13){jQuery('#err_tip')['text'](_0x543e('0x6'))[_0x543e('0xd')]();setTimeout(()=>{jQuery(_0x543e('0x8'))['text']('')['hide']();},0x9c4);flags=![];return![];}if(!_0x5e3f7d||_0x5e3f7d=='127.0.0.1'){jQuery('#err_tip')[_0x543e('0x4')]('请不要在本地搭建本主题，无法激活！')[_0x543e('0xd')]();setTimeout(()=>{jQuery('#err_tip')[_0x543e('0x4')]('')[_0x543e('0x9')]();},0x9c4);flags=![];return![];}let _0x40cdfe=Math['round'](new Date()[_0x543e('0x7')]()/0x3e8)[_0x543e('0xe')]();jQuery['ajax']({'url':'https://zy.51qux.com/api/codes','type':'put','data':{'domain':_0x5e3f7d,'code':_0x2c847b},'success':function(_0x2e8847){if(_0x2e8847['status']=='200'||_0x2e8847['status']=='209'){jQuery[_0x543e('0xc')]({'type':'post','url':'/wp-content/themes/QUIPlus/inc/ajaxPost.php','data':_0x543e('0xb')+_0x21be78+'&code_val='+_0x2c847b+_0x543e('0x5')+_0x40cdfe,'dataType':_0x543e('0x4'),'success':function(_0x4f4b9b){jQuery(_0x543e('0xa'))['show'](0xc8);},'error':function(_0x252c5e){jQuery(_0x543e('0x8'))[_0x543e('0x4')]('主题激活成功，创建本地数据失败！'+_0x252c5e)['show']();setTimeout(()=>{jQuery('#err_tip')[_0x543e('0x4')]('')['hide']();},0x9c4);}});flags=![];}else{jQuery(_0x543e('0x8'))[_0x543e('0x4')](_0x2e8847['messages'])[_0x543e('0xd')]();setTimeout(()=>{jQuery('#err_tip')[_0x543e('0x4')]('')['hide']();},0x9c4);flags=![];}}});}jQuery('#start-qui')['click'](()=>{jQuery('#success_boom')['hide'](0xc8);location[_0x543e('0x1')]();});
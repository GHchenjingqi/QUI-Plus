...
class QUI {
	...
	__setRem(){
		...
		if(w < 420){
			rem = window.innerWidth / 4.2
		}
		else if(w > 420 && w < 768){
			rem = window.innerWidth / 5
		}else if(w > 768 && w < 1000){
			rem = window.innerWidth / 6 
		}else if(w > 1000 && w < 1290){
	...
	__loading(loadingSrc){
		...
		// ./wp-content/themes/QUIPlus/static/QUI3.0/css/icons/loading.gif
